                  ...
                  <div className="card-body">
                    ...
                    <form className="form-horizontal" method="POST" onSubmit={this.handleSubmit} ref={(el) => { this.loginForm = el; }}>
                      <div className="form-group">
                        <label htmlFor="email">Эмайл хаяг</label>
                        <input
                          id="email"
                          type="email"
                          name="email"
                      ...
                      <div className="form-group">
                        ...
                        <input
                          ...
                          name="password"
                          placeholder="Нүүц үг оруулна уу"
                          required
                          onChange={this.handleChange}
                          onBlur={this.handleBlur}
                          disabled={loading}
                      ...
                      <div className="login-invite-text text-center">Бүртгүүлээгүй юм биш биз? <Link to="/register" href="/register">Бүртгүүлэх</Link>.</div>
                    </form>
                  </div>
                </div>
