                  ...
                  <div className="card-body">
                    ...
                    <form className="form-horizontal" method="POST" onSubmit={this.handleSubmit} ref={(el) => { this.loginForm = el; }}>
                      ...
                      <div className="alert alert-danger" role="alert">
                        Нэр эсвэл нууц үгээ буруу хийлээ. Дахин оролдоно уу
                      </div>
                      }
                      ...
                      <div className="login-invite-text text-center">{'Бүртгүүлээгүй юм биш биз?'} <Link to="/register">Бүртгүүлэх</Link>.</div>
                    </form>
                  </div>
                </div>
