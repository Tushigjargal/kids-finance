            ...
            <div className="row">
              <div className="section-login col-lg-6 ml-auto mr-auto">
                ...
                <div className="card-login card mb-3">
                  <div className="card-body">
                    ...
                    <div className="alert alert-success text-center" role="alert">
                      ...
                      <Link to="/" href="/">Та өөрийн эмайл болон нууц үгээ оруулж нэвтрэн орно уу!</Link>
                    </div>
                    }
                    ...
                    <form className="form-horizontal" method="POST" onSubmit={this.handleSubmit} ref={(el) => { this.registrationForm = el; }}>
                      ...
                      <div className="form-group">
                        ...
                        <input
                          ...
                          placeholder="Эмайлээ оруулна уу"
                          required
                          onChange={this.handleChange}
                          onBlur={this.handleBlur}
                          disabled={loading}
                      ...
                      <div className="form-group">
                        <label htmlFor="password_confirmation">Нууц үг баталгаажуулах</label>
                        <input
                ...
                <div className="password-reset-link text-center">
                  <Link to="/" href="/">
                    Бүртгэлтэй бол нэвтрэн орно уу!
                  </Link>
                </div>
                }
              </div>
